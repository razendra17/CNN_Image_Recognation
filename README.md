...
This project currently uses a relatively simple CNN architecture:
...
* [ ] Add a proper test dataset
* [ ] Generate a confusion matrix
* [ ] Calculate precision, recall, and F1-score
* [ ] Improve validation accuracy
* [ ] Experiment with different image sizes
* [ ] Try Transfer Learning
* [ ] Compare CNN with pretrained models such as MobileNet or EfficientNet
...
* How image datasets are structured
* How images are converted into tensors
* Image normalization
...
One of the main things I learned from this project is that a CNN does not directly understand an image as a human does.

Instead, the network gradually learns numerical patterns from the pixels.
...
This helped me understand the basic idea behind how image classification models work.

---

# ⚠️ Limitations

This is a **learning project**, so the model is not intended to be production-ready.
...
A high training accuracy does not automatically mean that the model will perform well on completely new images.
